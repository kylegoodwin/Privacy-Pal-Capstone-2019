export let stories = {
       ...
       moderation: [
              ...
              {url:"img/moderation/story10.png",topText:"He is an avid twitter user, star basketball player, and a great student!"},
              ...
              {url:"img/moderation/story13.gif",topText:"What had started as a small tweet quickly spiraled out of Ben’s control"},
              {url:"img/moderation/story14.png",topText:"His retweet spread to his teachers, parents, and principal"},
              {url:"img/moderation/story15.png",topText:"Even though he only retweeted once, Ben is held responsible for all the other actions that came from it"},
              ...
              {url:"img/moderation/story19.jpg",topText:"You’re finished with the Posting in Moderation Lesson!",bottomText:"Tap right, or go to the home button to work on the Discussion for this!"}
       ],
       ...
       identity: [
              ...
              {url:"img/identity/story9.png",topText:"This is Miguel. He is a quiet 7th grader", bottomText: "Miguel likes to go with the flow and have fun doing whatever his friends are doing"},
              ...
              {url:"img/identity/story11.gif",topText:"Miguel realizes the potential trouble he can get in ", bottomText:"The tweet claims the student was cheating on her He quickly leaves the group chat"},
              {url:"img/identity/story12.png",topText:"One day, one of the members of the group chat was messaging during class", bottomText:"The teacher sees this and takes the phone"},
              {url:"img/identity/story13.gif",topText:"The teacher sees all the messages and reports the group chat"},
              ...
              {url:"img/identity/story15.png",topText:"Miguel learned to be careful of the online groups that you are in",bottomText:"Being a part of them can get you in trouble"},
              {url:"img/identity/story16.gif",topText:"If an online group is hurtful towards someone, don’t get involved",bottomText:"This is cyberbullying and can potentailly get you into trouble and harm others"},
       ...
       friends: [
              ...
              {url: "img/friends/story10.png", topText: "She loves to write and is a frequent user of Instagram"},
              {url: "img/friends/story11.jpg", topText: "Because she has a public account, she constantly has new, random followers", "bottomText": "These followers keep direct messaging her questions"},
              {url: "img/friends/story12.jpg", topText: "One account pretended to be her friend and asked for sensitive information"},
              {url: "img/friends/story13.gif", bottomText: "Anna, not knowing any better, sent over her passwords and sensitive information"},
              {url: "img/friends/story14.jpg", bottomText: "Her personal information, like her home address, was now in the hands of other outsiders"},
              ...
              { url: "img/friends/story16.png", topText: "Anna realized something that day...", bottomText: "It is important to know who you are talking to before revealing yourself"},
              {url: "img/friends/story17.png", bottomText: "Be sure to look into the account you are talking to before engaging in conversation"},
              {url: "img/friends/story18.gif", topText: "Make sure that their account does not seem fake or harmful in any way"},
