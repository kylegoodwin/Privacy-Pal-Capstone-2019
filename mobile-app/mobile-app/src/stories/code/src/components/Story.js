  ...
  render() {
    ...
    return (
      ...
      <div id="story-container-extension" style={{ ...styles.story, width: this.props.width, height: this.props.height }}>
        ...
        { this.props.story.topText && <div style={{  zIndex: '9999', fontSize: '1.5em', color: 'white', position: 'absolute', top: '100px', background: 'rgba(0,0,0,.75)', padding: '20px',borderRadius: '20px'}}> {this.props.story.topText}</div>}
        {this.getStoryContent()}
        { this.props.story.bottomText && <div style={{  zIndex: '9999', fontSize: '1.5em', color: 'white', position: 'absolute', bottom: '100px', background: 'rgba(0,0,0,.75)', padding: '20px', borderRadius: '20px'}}>{this.props.story.bottomText}</div>}
