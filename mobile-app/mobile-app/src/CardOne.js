...
export class CardOne extends Component {
    ...
    render() {
        ...
        {url:"img/quiz-one/two.jpg",topText:"Stop using your phone so much!",bottomText:"Phones are bad for you!"},
        {url:"https://i.gifer.com/9bkM.gif",topText:"will this gif work?",bottomText:"We sure hope so!"},
        {url:"img/quiz-one/three.jpg",topText:"Wow",bottomText:"You use your phone too much son"},
        {url:"vid/test.mp4",type:"video"},
           {url:"img/quiz-one/four.jpg",topText:"Its not good to use your phone that much",bottomText:"stop it!"}
            ]

             //<button onClick={this.test}> Pause</button><button onClick={this.play}> Play</button>
