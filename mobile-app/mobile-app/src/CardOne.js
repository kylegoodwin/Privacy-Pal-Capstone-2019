...
export class CardOne extends Component {
    ...
    render() {
        ...
        let stories = ["img/quiz-one/one.png","img/quiz-one/two.png","img/quiz-one/three.png","img/quiz-one/four.png","img/quiz-one/five.png",{url:"img/quiz-one/three.png",isLastStory: true}]
        return (
            <Stories 
            stories={stories}
