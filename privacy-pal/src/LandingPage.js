    ...
    return (
      ...
      <div className = "row">
        {/* <section className="icons" align="center">  */}
            ...
            <div id="3" className="col md-4">
              <img className="screen-shots pr-4" src="img/identity.png"></img>
              <div>
        ...
        <div className="container">
          <div className = "row">
            {/* <section className="icons" align="center">  */}
                ...
                <div id="4" className="col-md-6">
                  <img className="screen-shots" src="img/story1.png"></img>
                  <div>
                    <p className="icon-caption text-center pr-5 font-weight-bold">Unknown Networks</p>
                  </div>
                </div>
          {/* </section> */}
        </div>
     ...
     {/* PARALLAX PICTURE SECTION*/}
      ...
      <p id="about">
        <div className="inner">
          <h1 className="ml-5 mb-5 display-2"> About the Project </h1>
          <h5 className="ml-5 mr-5">Privacy Pal is a Capstone project through the University of Washington's Informatics program. The team consists of Kyle Goodwin, Lucas Woo,
